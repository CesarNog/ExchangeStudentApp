...
/**
 * Main activity of the Exchange Student program
 * 
 * @author cesarnog
 */
public class MainActivity extends Activity {
	...
	private UniversityDataSource datasourceUniversity;
	...
	/*
	 * Your Facebook APP ID private static String APP_ID = "594696910579566"; //
	 * Replace your App ID here
	 * 
	 * private Facebook facebook; private AsyncFacebookRunner mAsyncRunner;
	 * String FILENAME = "AndroidSSO_data"; private SharedPreferences mPrefs;
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		datasourceUniversity = new UniversityDataSource(this);
		...
		chatDrawerList.setOnItemClickListener(new SlideMenuClickListener());
	...
	/*
	 * public void logoutFromFacebook() { mAsyncRunner.logout(this, null, new
	 * RequestListener() {
	 * 
	 * @Override public void onComplete(String response, Object state) {
	 * Log.d("Logout from Facebook", response); if
	 * (Boolean.parseBoolean(response) == true) { // User successfully Logged
	 * out } }
	 * 
